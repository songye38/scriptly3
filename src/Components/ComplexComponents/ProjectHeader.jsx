...
const ProjectHeader = ({ activeTab, onTabChange, title }) => {
  ...
  <div
    style={{
      ...
      height: 31,
      padding: 4,
      background: activeTab === 'study' ? '#CED5FB' : '#F5F5F5', // activeTab에 따라 배경색 변경
      borderRadius: 4,
  ...
  >
    <div
      style={{
        color: activeTab === 'study' ? '#3150EE' : '#8C8C8C', // activeTab에 따라 텍스트 색상 변경
        fontSize: 14,
  ...
  <div
    style={{
      ...
      height: 31,
      padding: 4,
      background: activeTab === 'organizing' ? '#CED5FB' : '#F5F5F5', // activeTab에 따라 배경색 변경
      borderRadius: 4,
  ...
  >
    <div
      style={{
        color: activeTab === 'organizing' ? '#3150EE' : '#8C8C8C', // activeTab에 따라 텍스트 색상 변경
        fontSize: 14,
        fontFamily: 'Pretendard',
        fontWeight: '500',
        lineHeight: 23,
